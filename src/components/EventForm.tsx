    ...
    <div className="container-responsive py-6 sm:py-8 lg:py-12">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:p-8">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-gray-600 text-sm sm:text-base">Fill in the details below to create your event page</p>
        </div>
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              <div className="lg:col-span-2">
                ...
                <input
                  ...
                  type="text"
                  id="title"
                  className="w-full px-3 py-3 sm:py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base sm:text-sm touch-target"
          ...
          <section className="space-y-4 sm:space-y-6">
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Organizer Information</h2>
            </div>
          ...
          <section className="space-y-4 sm:space-y-6">
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Branding</h2>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    type="color"
                    id="primaryColor"
                    className="w-12 h-12 sm:w-10 sm:h-10 border border-gray-300 rounded cursor-pointer touch-target"
                  />
                  <input
                    {...register('primaryColor')}
                    type="text"
                    className="flex-1 px-3 py-3 sm:py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base sm:text-sm"
                    placeholder="#3B82F6"
                  />
                </div>
                {errors.primaryColor && (
          ...
          <section className="space-y-4 sm:space-y-6">
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Event Media</h2>
            </div>
          ...
          <section className="space-y-4 sm:space-y-6">
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              ...
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Additional Settings</h2>
            </div>
          ...
          <div className="flex justify-end pt-6 border-t border-gray-200">
            <button
              type="submit"
              disabled={isLoading}
              className="w-full sm:w-auto px-6 py-3 bg-blue-600 text-white font-medium rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed touch-target text-base sm:text-sm"
            >
